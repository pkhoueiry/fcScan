...
fcScan requires the following packages to be installed :
...
user using `chr = "chrom1" str = "+"`, and the size of these 
...
```
input.bed = mappedClusters[,5:8]
mouse.bed = mappedClusters[,1:4]
mouse.bed$Start = as.integer(mouse.bed$Start)
mouse.bed$End = as.integer(mouse.bed$End)
data(UCSC.Mouse.GRCm19.CytoBandIdeogram)
...
cyto.list <- list(UCSC.HG38.Human.CytoBandIdeogram,UCSC.Mouse.GRCm19.CytoBandIdeogram)
