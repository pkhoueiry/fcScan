...
>`clusters = getCluster(x=c("~/project/fcScan/data/NANOG.bed","~/project/fcScan/data/TATA.bed"), w = 1500, c = c("NANOG"=1,"TATA"=2), greedy = TRUE, overlap = -5, s = "+", chr = "chr9",order = c("TATA_known2","NANOG_known1","NANOG_known1"))`
...
`order = c("TATA_known2","NANOG_known1","NANOG_known1")`
...
For example if a cluster has "TATA_known2 TATA_known2 NANOG_known1 NANOG_known1 NANOG_known1", this cluster has the required order and therefore will be conisdered as a correct cluster.
(Default is **NULL**)
...
```{r, echo=FALSE, results='asis'}
df <- data.frame(chr = c("chr9", "chr9", "chr9", "chr9", "chr9", "chr9","chr9"), 
                 ...
                 isCluster = c("FALSE", "FALSE", "FALSE", "FALSE", "FALSE",
                  ...
                  status = c("combnFail", "combnFail", "combnFail", 
                    "combnFail", "combnFail", "combnFail","orderFail"),
